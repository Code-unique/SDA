// app/api/courses/[id]/payment/initiate/route.ts
      ...
      try {
        ...
        const paymentIntent = await createStripePaymentIntent({
          ...
          metadata: {
            ...
            userEmail: userEmail,
            courseTitle: course.title.substring(0, 100)
          },
    ...
    if (paymentMethod === 'khalti') {
      try {
        ...
        const khaltiPayload = {
          ...
          website_url: baseUrl,
          amount: amountInNPR * 100, // Amount in paisa (100 paisa = 1 NPR)
          ...
          amount_breakdown: [
            { label: 'Course Fee', amount: amountInNPR * 100 }
          ],
          product_details: [
            {
              identity: (course._id as mongoose.Types.ObjectId).toString(),
              name: course.title.substring(0, 64),
              total_price: amountInNPR * 100,
              quantity: 1,
              unit_price: amountInNPR * 100
            }
          ]
        };
