...
export const uploadPostMedia = async (file, type, onProgress) => {
    return new Promise((resolve, reject) => {
        ...
        xhr.open('POST', `https://api.cloudinary.com/v1_1/${POSTS_CLOUDINARY_CONFIG.cloudName}/${type}/upload`);
        xhr.send(formData);
    });
};
...
export const processPostMedia = async (fileBuffer, fileName, type) => {
    return new Promise((resolve, reject) => {
