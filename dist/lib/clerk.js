...
export async function POST(req) {
    ...
    if (eventType === 'user.updated') {
        ...
        try {
            await connectToDatabase();
            const updateData = {};
            if ((_b = email_addresses === null || email_addresses === void 0 ? void 0 : email_addresses[0]) === null || _b === void 0 ? void 0 : _b.email_address) {
            ...
            if (image_url)
                updateData.avatar = image_url;
            await User.findOneAndUpdate({ clerkId: id }, { $set: updateData }, { new: true });
