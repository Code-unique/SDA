export function advancedDetectIntent(text) {
    ...
    if (t.includes('how to'))
        subIntents.push('tutorial');
    if (t.includes('compare'))
        subIntents.push('comparison');
    if (t.includes('best') || t.includes('worst'))
        subIntents.push('evaluation');
    if (t.includes('why') || t.includes('reason'))
        subIntents.push('explanation');
    if (t.includes('example') || t.includes('case study'))
        subIntents.push('example');
    // Sentiment analysis
